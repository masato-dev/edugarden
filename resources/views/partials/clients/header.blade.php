                ...
                @auth('user:web')
                    <div class="d-flex align-items-center justify-content-end gap-3">
                        <a href="{{ route('carts.index') }}"
                            class="k-btn btn-text-color d-flex gap-2 text-decoration-none py-3" id="headerCartBtn">
                        ...
                        <div class="dropdown">
                            <button class="k-btn btn-main dropdown-toggle d-flex gap-2 py-3" type="button"
